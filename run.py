...
def generate_certificates():
   ...
   for index, name in enumerate(list_of_names):
      ...
      cv2.putText(certificate_template_image, name.strip(), (815,1500), cv2.FONT_HERSHEY_SIMPLEX, 5, (0, 0, 250), 5, cv2.LINE_AA)  #certificate image, names, x&y axis,font,scale,color,thickness,line
